					...
					<div id="modifyForm">
						<form action="/mysite2/user" method="post">
							...
							<div class="form-group">
								...
								<span class="text-large bold"><%=user.getId()%></span>
							</div>
	
							<!-- 비밀번호 -->
							<div class="form-group">
								<label class="form-text" for="input-pass">패스워드</label> 
								<input type="password" id="input-pass" name="pw" value="<%=user.getPw()%>" placeholder="비밀번호를 입력하세요"	>
							</div>
	
							<!-- 이메일 -->
							<div class="form-group">
								<label class="form-text" for="input-name">이름</label> 
								<input type="text" id="input-name" name="name" value="<%=user.getName()%>" placeholder="이름을 입력하세요">
							</div>
